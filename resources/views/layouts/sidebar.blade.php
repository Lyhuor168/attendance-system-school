    ...
    <nav class="flex-1 space-y-1 overflow-y-auto px-3 py-4">
        @php
            $links = [
                ...
                ['route' => 'attendance.index', 'label' => 'Attendance', 'pattern' => 'attendance.*', 'admin_only' => false, 'hidden_from_students' => true, 'hidden_from_guardians' => true],
                ['route' => 'leave-requests.index', 'label' => 'Leave Requests', 'pattern' => 'leave-requests.*', 'admin_only' => false, 'hidden_from_guardians' => true],
                ['route' => 'chat.index', 'label' => 'Messages', 'pattern' => 'chat.*', 'admin_only' => false, 'hidden_from_students' => true, 'hidden_from_admins' => true],
            ...
            $icons = [
                ...
                'Leave Requests' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4',
        ...
        @foreach ($links as $link)
            ...
            @continue(($link['hidden_from_guardians'] ?? false) && auth()->user()->isGuardian())
            @continue(($link['hidden_from_admins'] ?? false) && auth()->user()->isAdmin())
